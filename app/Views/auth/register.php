...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo base_url('auth/register'); ?>"><b>SIAK </b>Online</a>
        </div>
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <div class="input-group mb-3">
                    ...
                    $username = [
                        ...
                        'name' => 'username',
                        'id' => 'username',
                        'value' => isset($inputs['username']) ? $inputs['username'] : '', // Periksa apakah 'username' ada di $inputs
                        'class' => 'form-control',
                ...
                <div class="input-group mb-3">
                    ...
                    $name = [
                        ...
                        'name' => 'name',
                        'id' => 'name',
                        'value' => isset($inputs['name']) ? $inputs['name'] : '', // Periksa apakah 'name' ada di $inputs
                        'class' => 'form-control',
                ...
                <div class="input-group mb-3">
                    ...
                    $email = [
                        ...
                        'name' => 'email',
                        'id' => 'email',
                        'value' => isset($inputs['email']) ? $inputs['email'] : '', // Periksa apakah 'email' ada di $inputs
                        'class' => 'form-control',
                ...
                <div class="input-group mb-3">
                    ...
                    $password = [
                        ...
                        'name' => 'password',
                        'id' => 'password',
                        'value' => isset($inputs['password']) ? $inputs['password'] : '', // Periksa apakah 'password' ada di $inputs
                        'class' => 'form-control',
                ...
                <div class="input-group mb-3">
                    ...
                    $confirm_password = [
                        ...
                        'id' => 'confirm_password',
                        'value' => isset($inputs['confirm_password']) ? $inputs['confirm_password'] : '', // Periksa apakah 'confirm_password' ada di $inputs
                        'class' => 'form-control',
